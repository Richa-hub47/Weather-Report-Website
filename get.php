<html>
<head><title>Weather Report of <?php echo $_GET['q']; ?> - WeatherReport.com</title>
...
?>
	...
	<div class="w3-display-container w3-wide">
		<img src="./img/17153898_web1_clouds_newsFP.jpg" style="width:100%;height:100%;" class="w3-image">
